...
// =====================================================
// PIN CONFIGURATION (from original LEFT shoe code)
// =====================================================
...
const int NOISE_CM         = 5;    // change of 5 cm or less = noise (stable)
